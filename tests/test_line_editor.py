...
def test_editor_insert_string():
    ...
    e.backspace()
    e.append('cat')
    assert str(e) == "The quick brown cat"
    assert e.cursor_position() == 19
...
def test_editor_move_cursor():
    ...
    e.cursor_move(4)
    e.append('very ')
    assert str(e) == "The very quick brown fox"
...
def test_editor_move_cursor_off_end():
    ...
    e.cursor_move(40)
    e.append('very ')
    assert str(e) == "The quick brown foxvery "
...
def test_editor_move_cursor_off_start():
    ...
    assert e.cursor_position() == 0
    e.append('very ')
    assert str(e) == "very The quick brown fox"
...
def test_editor_copy_character():
    ...
    assert str(e) == "qThe quick brown fox"
    assert e.cursor_position() == 1
